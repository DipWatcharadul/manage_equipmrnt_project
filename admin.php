  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #007bff;">
    ...
    <div class="content">
        ...
        <div class="container mt-5">
            <form method="POST" action="admin_search_equipment.php">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card text-white bg-success mb-3" onclick="window.location='admin_equipment_status.php?status=1'">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-white" style="background-color: #FF8C00;" onclick="window.location='admin_equipment_status.php?status=2'">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-danger mb-3" onclick="window.location='admin_equipment_status.php?status=3'">
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card text-white bg-primary mb-3" onclick="window.location='admin_repair_schedule_status.php?status=1'">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-white" style="background-color: #FF8C00;" onclick="window.location='admin_repair_schedule_status.php?status=2'">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-success mb-3" onclick="window.location='admin_repair_schedule_status.php?status=3'">
                        <div class="card-body">
